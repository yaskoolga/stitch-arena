...
**🤖 Автоматическое определение стежков (v0.8.0+):**

1. Открой http://localhost:3000
2. Залогинься
3. Создай или открой проект
4. **Способ A - Daily Log Form**:
   - Нажми "Add Log"
   - Выбери фото вышивки
   - Система автоматически определит количество стежков
   - Увидишь бейдж уверенности: 🤖 85% confident
   - Поле стежков автозаполнится (если уверенность ≥50%)
   - Можешь скорректировать вручную
5. **Способ B - Quick Upload**:
   - На странице проекта нажми "Add Photo"
   - Выбери фото
   - Система автоматически создаст лог с определённым количеством
   - Toast покажет уверенность: "✅ Detected 250 stitches (85% confident)"

**📊 Pattern Analyzer (старый способ):**

1. На странице проекта используй компонент `PatternAnalyzer`
2. Загрузи фото схемы
3. Нажми "Analyze Pattern"
4. Увидишь результат с количеством крестиков
